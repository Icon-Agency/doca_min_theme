  ...
  attach: function(context, settings) {
    ...
    $('.view-grid2 .grid-item.grid').each(function() {
        if($(this).hasClass('Minister')) {
            ...
            $('.view-grid2 .view-header style').append('.'+grid_pos+' .bt {background-color: #'+header_border_color+'}');
        }
    ...
    // Views - Minister Social Channels. For each channel get URL to wrap tile footer with link to ministers social site.
